...
public class MissionThree : Mission
{
    ...
    public void StartCutsceneWithConversation()
    {
        ...
        GameObject.FindGameObjectWithTag("Player").gameObject.GetComponent<PlayerMovement>().allowedToMove = false;
        cutscenesParent.transform.GetChild(2).gameObject.GetComponent<PlayableDirector>().stopped += OnPlayableDirectorStopped;
        GameObject.FindGameObjectWithTag("Player").GetComponents<DialogueSystemTrigger>()[2].enabled = true;
    ...
    void OpenNote()
    {
        ...
        ES3.Save<int>("notesCollectedLengthMission_3", inventoryManager.GetComponent<InventoryManager>().notes.Count);
    ...
    void OpenNewspaper()
    {
        ...
        ES3.Save<int>("newsPaperCollectedLengthMission_3", inventoryManager.GetComponent<InventoryManager>().newspapers.Count);
